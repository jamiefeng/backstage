<?php
namespace Phalcon\Net\Protocol\ProtocolBuffer\Message;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Encoding\Base128varint;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBScalar;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBEnum;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBBytes;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBString;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBInt;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBBool;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Type\PBSignedInt;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Reader\PBInputReader;
use Phalcon\Net\Protocol\ProtocolBuffer\Message\Reader\PBInputStringReader;
...
abstract class PBMessage
{
    ...
    private function _ParseFromArray($length=99999999)
    {
        ...
        while ($this->reader->get_pointer() - $_begin < $length)
        {
            ...
            {
                $this->fields[$messtypes['field']] = "Phalcon\\Net\\Protocol\\ProtocolBuffer\\Message\\Type\\".$this->fields[$messtypes['field']];
                $this->values[$messtypes['field']] = new $this->fields[$messtypes['field']]($this->reader);
    ...
    protected function _set_value($index, $value)
    {
        ...
        {
            $this->fields[$index] = "Phalcon\\Net\\Protocol\\ProtocolBuffer\\Message\\Type\\".$this->fields[$index];
