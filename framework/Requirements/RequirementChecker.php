...
/**
 * CoreRequirementChecker allows checking, if current system meets the requirements for running the Joy application.
 * This class allows rendering of the check report for the web and console application interface.
 *
 * Example:
 *
 * ~~~php
 * require_once('path/to/RequirementChecker.php');
 ...
 * ),
 * );
 * $requirementsChecker->checkCore()->check($requirements)->render();
 * ~~~
 *
...
class RequirementChecker
{
    ...
    /**
     * Performs the check for the core requirements.
     * 
     ...
     * 
     * @return array|null results in format:
     *        
     *         ```php
     *         array(
     *         'summary' => array(
